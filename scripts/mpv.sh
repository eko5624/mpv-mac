...
#patch -p1 -i 2.patch
sed -i "" '/wantsExtendedDynamicRangeContent = true/d' video/out/mac/gl_layer.swift
sed -i "" '/wantsExtendedDynamicRangeOpenGLSurface = true/d' video/out/mac/view.swift
